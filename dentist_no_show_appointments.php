...
$stmt = $conn->prepare("
    ...
    WHERE a.dentist_id = ? AND a.appointment_status = 'no_show'
    ...
    <div class="main-content">
        ...
        <nav class="app">
            <ul class="app-links">
                ...
                <li><a href="dentist_no_show_appointments.php" class="active">No Show</a></li>
            </ul>
        </nav>
        ...
        <table>
            ...
            <tbody>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="6">No Show appointments found.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
