...
// Fetch completed patient appointments along with patient details
$appointments = [];
$stmt = $conn->prepare("
    SELECT 
        a.appointment_id, 
        ...
        GROUP_CONCAT(COALESCE(s.service_name, 'No Service') SEPARATOR ', ') AS services
    FROM appointments a
    ...
    WHERE a.dentist_id = ? AND a.appointment_status = 'completed'
...
<div class="main-content">
    ...
    <nav class="app-links">
        <ul>
            <li><a href="dentist_patient_appointments.php">Upcoming Appointments</a></li>
            <li><a href="dentist_pending.php">Pending</a></li>
            <li><a href="dentist_cancelled.php">Cancelled</a></li>
            <li><a href="dentist_completed.php" class="active">Done</a></li>
